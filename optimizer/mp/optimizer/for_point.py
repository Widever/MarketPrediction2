...
def check_combs_for_point() -> bool:
    combs: list[CombGrade] = [
        CombGrade(comb=('#tag_btc_eth_log_return_ratio_gt_1.1',
                        '#tag_eth_ada_log_return_ratio_gt_0.8',
                        '#tag_eth_doge_log_return_ratio_lt_0.75',
                        '#tag_eth_ada_amp_ratio_gt_0.9',
                        '#tag_eth_doge_amp_ratio_lt_0.87'), count_=88, sl_count=18, uniformity=0.0,
                  k=3.888888888888889,
                  verify_grade=CombGrade(comb=None, count_=32, sl_count=7, uniformity=None, k=3.5714285714285716,
                                         verify_grade=None)),
        CombGrade(comb=('#tag_btc_doge_log_return_ratio_lt_0.2',
                        '#tag_eth_doge_log_return_ratio_lt_1.0', '#tag_ada_price_up_false',
                        '#tag_btc_doge_amp_ratio_lt_0.36',
                        '#tag_eth_ada_amp_ratio_lt_0.9'), count_=89, sl_count=19, uniformity=0.0,
                  k=3.6842105263157894,
                  verify_grade=CombGrade(comb=None, count_=31, sl_count=7, uniformity=None, k=3.4285714285714284,
                                         verify_grade=None)),
        CombGrade(comb=('#tag_btc_ada_log_return_ratio_gt_0.62',
                        '#tag_eth_doge_log_return_ratio_lt_0.25',
                        '#tag_all_same_price_dir_false', '#tag_btc_eth_amp_ratio_lt_0.65',
                        '#tag_eth_ada_amp_ratio_gt_0.9'), count_=97, sl_count=21, uniformity=0.0,
                  k=3.619047619047619,
                  verify_grade=CombGrade(comb=None, count_=44, sl_count=10, uniformity=None, k=3.4, verify_grade=None)),
        CombGrade(comb=('#tag_btc_eth_log_return_ratio_lt_0.5',
                        '#tag_btc_eth_amp_ratio_gt_0.65',
                        '#tag_btc_doge_amp_ratio_lt_0.36',
                        '#tag_eth_ada_amp_ratio_lt_0.67'), count_=72, sl_count=16, uniformity=0.0,
                  k=3.5,
                  verify_grade=CombGrade(comb=None, count_=32, sl_count=8, uniformity=None, k=3.0, verify_grade=None)),
        CombGrade(comb=('#tag_btc_doge_log_return_ratio_lt_0.2',
                        '#tag_eth_ada_log_return_ratio_lt_0.8', '#tag_btc_price_up_false',
                        '#tag_btc_eth_amp_ratio_gt_0.65',
                        '#tag_btc_ada_amp_ratio_lt_0.6'), count_=89, sl_count=18, uniformity=0.0,
