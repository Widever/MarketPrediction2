...
def super_benchmark(combs: list[CombGrade] = None, use_inner_combs: bool = False, use_custom_marked_points: bool = False):
    if use_inner_combs:
        ...
        elif data.MAIN_SYMBOL == "DOGEUSDT":
            combs: list[CombGrade] = [
                CombGrade(
        ...
        elif data.MAIN_SYMBOL == "AVAXUSDT":
            combs: list[CombGrade] = [
    ...
    print("Mode 1:")
    profit, loss = profit_loss_in_df(marked_points_df, 1)
    print(f"{profit=}")
    print(f"{loss=}")
    print("Mode 2:")
    profit, loss = profit_loss_in_df(marked_points_df, 2)
    print(f"{profit=}")
    print(f"{loss=}")
...
if __name__ == "__main__":
    # super_benchmark([])
    super_benchmark(use_inner_combs=True, use_custom_marked_points=False)